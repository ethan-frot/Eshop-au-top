...
<main class="d-flex justify-content-center align-items-center flex-column text-center">
    <h1 class="display-4">Commande payée !</h1>
    <p class="lead">Votre commande a été payée (je crois). On revient vers vous plus tard pour vous dire si c'est ok ou pas.</p>
